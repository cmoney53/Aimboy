-- // CLEANUP PREVIOUS
local UI_NAME = "EliteMasterV15_Final"
...
-- // BUTTON CONNECTIONS (Fixed Interaction)
...
MinBtn.MouseButton1Down:Connect(function()
    ...
    Main:TweenSize(IS_MINIMIZED and UDim2.new(0, 200, 0, 35) or UDim2.new(0, 200, 0, 320), "Out", "Quad", 0.15, true)
    if IS_MINIMIZED then PListFrame.Visible = false end
end)

PListToggle.MouseButton1Down:Connect(function()
...
HeadBtn.MouseButton1Down:Connect(function() setT(HeadBtn, "Head") end)
ChestBtn.MouseButton1Down:Connect(function() setT(ChestBtn, "Chest") end)
LegBtn.MouseButton1Down:Connect(function() setT(LegBtn, "Legs") end)

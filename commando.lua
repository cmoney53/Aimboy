...
MinimizeButton.Text = "-"
MinimizeButton.TextColor3 = neonColor
MinimizeButton.TextSize = 20
MinimizeButton.ZIndex = 10

local minimized = false
local originalSize = UDim2.new(0, 250, 0, 220)

MinimizeButton.MouseButton1Click:Connect(function()
    minimized = not minimized
    if minimized then
        Holder:TweenSize(UDim2.new(0, 250, 0, 25), "Out", "Quart", 0.3, true)
        MinimizeButton.Text = "+"
    else
        Holder:TweenSize(originalSize, "Out", "Quart", 0.3, true)
        MinimizeButton.Text = "-"
    end
end)
...
Holder.Active = true
Holder.Draggable = true -- Makes it floating
Holder.BackgroundColor3 = backgroundColor
Holder.BorderSizePixel = 2
Holder.BorderColor3 = neonColor -- Neon Glow Border
...
Title.Size = UDim2.new(1, -30, 0, 20) -- Shortened to fit minimize button
Title.Font = Enum.Font.SourceSansBold
Title.TextSize = 18
Title.Text = "NEON INTERFACE"
Title.TextColor3 = neonColor -- Neon Text
Title.ZIndex = 10
end

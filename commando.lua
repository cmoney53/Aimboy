...
-- Make Title bar draggable for the entire Holder
task.spawn(function()
...
PrefixBox.Text = ''
PrefixBox.TextColor3 = Color3.fromRGB(0, 255, 0)
PrefixBox.ZIndex = 10
...
Delete_2.TextColor3 = Color3.fromRGB(0, 255, 0)
Delete_2.ZIndex = 10
...
Delete_6.TextColor3 = Color3.fromRGB(0, 255, 0)
Delete_6.ZIndex = 10
...
Delete_4.TextColor3 = Color3.fromRGB(0, 255, 0)
Delete_4.ZIndex = 10
...
Delete_7.TextColor3 = Color3.fromRGB(0, 255, 0)
Delete_7.ZIndex = 10
...
SaveChatlogs.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
scroll_2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
join.Active = true
join.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
Clear_2.Name = "Clear"
Clear_2.Parent = join
Clear_2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
scroll_3.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
selectChat.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
selectJoin.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
...
currentText1 = Color3.fromRGB(0, 255, 0)
currentText2 = Color3.fromRGB(0, 255, 0)
currentScroll = Color3.fromRGB(0, 200, 0)
...
function maximizeHolder()
	if StayOpen == false then
		Holder:TweenPosition(UDim2.new(0.5, -125, 0.5, -110), "InOut", "Quart", 0.2, true, nil)
	end
end
...
function minimizeHolder()
	if StayOpen == false then
		Holder:TweenPosition(UDim2.new(0.5, -125, 0.5, -110), "InOut", "Quart", 0.5, true, nil)
	end
end
...
function UpdateToViewport()
	if Holder.Position.X.Offset < -CamViewport() then
		Holder:TweenPosition(UDim2.new(0.5, -125, Holder.Position.Y.Scale, Holder.Position.Y.Offset), "InOut", "Quart", 0.04, true, nil)
